 ...
 <header>
  ...
  <h1></h1>
      <div className="carousel-inner">
         <img src="https://storage.sg.content-cdn.io/cdn-cgi/image/width=1800,height=490,quality=75,format=auto/in-resources/6c57599f-2c43-4c82-806a-e07c3410f5d3/Images/userimages/home-page-banners/1-2-2021/girls2.jpg"alt="first"></img>
         <img src="https://storage.sg.content-cdn.io/cdn-cgi/image/width=1800,height=490,quality=75,format=auto/in-resources/6c57599f-2c43-4c82-806a-e07c3410f5d3/Images/userimages/home-page-banners/1-2-2021/up502.jpg"alt="first"></img>
         <img src="https://storage.sg.content-cdn.io/cdn-cgi/image/width=1800,height=490,quality=75,format=auto/in-resources/6c57599f-2c43-4c82-806a-e07c3410f5d3/Images/userimages/home-page-banners/1-3-21/holi.jpg "alt="first"></img>
         </div>
      ...
      <div className="carousel-inner">
         ...
         <h1 className="carousel-caption">black cotton flax straight kurtha</h1>
      ...
      <div className="carousel-inner">
         <hr></hr>
        <h3 className="text-left">Biba Indian Wear – Best Indian Ethnic Wear Dresses Online For women</h3>
        <hr></hr>
        ...
        <h3 className="text-left">Biba Spring Summer Collection</h3> 
        <hr></hr>
        ...
        <h3 className="text-left">Biba Autumn Winter Collection</h3>
        <hr></hr>
        ...
        <h3 className="text-left">Indian Ethnic Wear For Women – Categories And Work</h3>
        <hr></hr>
        ...
        <h3 className="text-left">Trendy Indian Ethnic Wear Online for Women</h3>
        <hr></hr>
        ...
        <h3 className="text-left">Shopping Ethnic Dresses For Women Online – Ethnic Wear Online Shopping</h3>
        <hr></hr>
        ...
        <h3 className="text-left">Role of Ethnic Dresses In Indian Wear</h3>
        <hr></hr>
    ...
    <div className="container">
      <div className="col">
        ...
        <div className="col-lg-12 text-center">
          ...
          <p className="text-left">Business Enquiry</p>
          <p className="text-left">careers</p>
          <p className="text-left">sitemap</p>
          <p className="text-left">sitemap.xml</p>
          <p className="text-left">privacy policy</p>
          <p className="text-left">Terms</p>
        </div>
        <div className="col-lg-12 text-center">
          <h2 className="section-heading text-uppercase"></h2>
          <hr></hr>
          <h3 className="text-left">Customer service</h3>
          <p className="text-left">Payment options</p>
          <p className="text-left">Delivery</p>
          <p className="text-left">Returns & cancellation</p>
        ...
        <div className="col-lg-12 text-center">
          <h2 className="section-heading text-uppercase"></h2>
          <hr></hr>
          <h3 className="text-left">My account</h3>
          <p className="text-left">my account</p>
          <p className="text-left">order history</p>
          <p className="text-left">Track order</p>
          <p className="text-left">Wishlist</p>
          <p className="text-left">Contact us</p>
      ...
      <div className="row">
        ...
        <div className="col-sm-4">
          <div className="team-member">
            <hr></hr>
            <h4></h4>
            <p className="text-muted">Cards accepted</p>
            <ul className="list-inline social-buttons">
    ...
    <div className="container">
      <div className="row align-items-center">
        <div className="col-md-4">
          <hr></hr>
          <span className="text-left">Copyright   <i className="fa fa-copyright"></i></span>
